...
You can edit the `src/cljs/clarke_wallet/core.cljs` file and the changes should show up in the electron app without the need to re-launch.
        ...
        {:figwheel-options {:css-dirs ["app/css"]}
         ...
         :all-builds
           [{:id "dev"
             ...
             :compiler {:main "clarke-wallet.dev"
                        :asset-path "js/p/out"
